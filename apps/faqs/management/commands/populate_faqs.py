...
class Command(BaseCommand):
    help = 'Populate FAQ data from mock data'
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(
            self.style.SUCCESS(
                f'Successfully populated {FAQCategory.objects.count()} categories, '
                f'{FAQSubcategory.objects.count()} subcategories, '
                f'and {FAQItem.objects.count()} FAQ items'
            )
        )
